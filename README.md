...
![alt text here](Pendulum math model front.png)

![Alt text](/MECA482-Teague-Singh/Images/Pendulum math model front.jpg?raw=true "Optional title")

![Alt text](/Pendulum math model front.png)
